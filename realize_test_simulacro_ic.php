...
<head>
    ...
    <?php
        ...
        $preguntasAleatorias = ($numPreguntas > 40) ? array_rand($preguntas, 40) : array_keys($preguntas);
...
<body>
    ...
    <script>
        // Define el tiempo inicial en segundos (20 minutos)
        var tiempoInicial = 45 * 60;
